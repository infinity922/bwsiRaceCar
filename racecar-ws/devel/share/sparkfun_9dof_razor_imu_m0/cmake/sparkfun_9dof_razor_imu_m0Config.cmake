...
if("TRUE" STREQUAL "TRUE")
  set(sparkfun_9dof_razor_imu_m0_SOURCE_PREFIX /home/ubuntu/racecar-ws/src/racecar/sparkfun_9dof_razor_imu_m0)
  set(sparkfun_9dof_razor_imu_m0_DEVEL_PREFIX /home/ubuntu/racecar-ws/devel)
  ...
  set(sparkfun_9dof_razor_imu_m0_INSTALL_PREFIX /home/ubuntu/racecar-ws/install)
...
if(NOT "/home/ubuntu/racecar-ws/src/racecar/sparkfun_9dof_razor_imu_m0/include " STREQUAL " ")
  set(sparkfun_9dof_razor_imu_m0_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/racecar-ws/src/racecar/sparkfun_9dof_razor_imu_m0/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sparkfun_9dof_razor_imu_m0' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'sparkfun_9dof_razor_imu_m0' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/racecar-ws/src/racecar/sparkfun_9dof_razor_imu_m0/${idir}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
