...
if("TRUE" STREQUAL "TRUE")
  set(racecar_potential_field_controller_SOURCE_PREFIX /home/ubuntu/racecar-ws/src/racecar-controllers/racecar_potential_field_controller)
  set(racecar_potential_field_controller_DEVEL_PREFIX /home/ubuntu/racecar-ws/devel)
  ...
  set(racecar_potential_field_controller_INSTALL_PREFIX /home/ubuntu/racecar-ws/install)
...
if(NOT "/home/ubuntu/racecar-ws/devel/include;/home/ubuntu/racecar-ws/src/racecar-controllers/racecar_potential_field_controller/include;/usr/include/eigen3 " STREQUAL " ")
  set(racecar_potential_field_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/racecar-ws/devel/include;/home/ubuntu/racecar-ws/src/racecar-controllers/racecar_potential_field_controller/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'racecar_potential_field_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'racecar_potential_field_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/racecar-ws/src/racecar-controllers/racecar_potential_field_controller/${idir}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/racecar-ws/devel/lib;/home/ubuntu/racecar-ws/devel/lib;/opt/ros/kinetic/lib)
