...
if("TRUE" STREQUAL "TRUE")
  set(racecar_SOURCE_PREFIX /home/ubuntu/racecar-ws/src/racecar/racecar)
  set(racecar_DEVEL_PREFIX /home/ubuntu/racecar-ws/devel)
  set(racecar_INSTALL_PREFIX "")
  set(racecar_PREFIX ${racecar_DEVEL_PREFIX})
else()
  set(racecar_SOURCE_PREFIX "")
  set(racecar_DEVEL_PREFIX "")
  set(racecar_INSTALL_PREFIX /home/ubuntu/racecar-ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'racecar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/racecar-ws/src/racecar/racecar/${idir}'.  Ask the maintainer 'Michael Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
